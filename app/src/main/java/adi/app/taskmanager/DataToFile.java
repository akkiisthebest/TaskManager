...
public class DataToFile {
    static LinkedList<String> completedlist = new LinkedList<String>();
    static LinkedList<String> todolist = new LinkedList<String>();

    public static void put(Context context,LinkedList<String> hi,String filename) {
    ...
    public static int index(LinkedList<String> ll, String addDate) {
